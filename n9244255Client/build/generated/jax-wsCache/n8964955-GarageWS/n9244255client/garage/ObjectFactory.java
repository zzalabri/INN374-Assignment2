 ...
 * generated in the n9244255client.garage package. 
...
public class ObjectFactory {
    ...
    private final static QName _SetAppointmentPlateNo_QNAME = new QName("http://tempuri.org/", "plateNo");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: n9244255client.garage
     * 
     */
    ...
    /**
     * Create an instance of {@link SetAppointment }
     * 
     */
    public SetAppointment createSetAppointment() {
        return new SetAppointment();
    }
    ...
    public JAXBElement<String> createSetAppointmentPlateNo(String value) {
        return new JAXBElement<String>(_SetAppointmentPlateNo_QNAME, String.class, SetAppointment.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "plateNo", scope = GetAppointment.class)
    public JAXBElement<String> createGetAppointmentPlateNo(String value) {
        return new JAXBElement<String>(_SetAppointmentPlateNo_QNAME, String.class, GetAppointment.class, value);
    }
